...
public class EnrollmentController extends FXController {
    ...
    private boolean validateFields() {
        ...
        isValid &= ValidationUtils.validateRequired(firstNameField);
        isValid &= ValidationUtils.validateRequired(lastNameField);
        isValid &= ValidationUtils.validateRequired(streetField);
        isValid &= ValidationUtils.validateRequired(cityField);
        isValid &= ValidationUtils.validateRequired(municipalityField);
        isValid &= ValidationUtils.validateRequired(barangayField);

        // Validate optional fields with specific formats
        isValid &= ValidationUtils.validateEmail(emailField);
        isValid &= ValidationUtils.validatePhone(contactNumberField);
        isValid &= ValidationUtils.validatePostal(postalCodeField);
        isValid &= ValidationUtils.validateFare(fareField);

        // Validate guardian fields
        isValid &= ValidationUtils.validateRequired(guardianFirstNameField);
        isValid &= ValidationUtils.validateRequired(guardianLastNameField);
        isValid &= ValidationUtils.validateRequired(guardianRelationshipField);
        isValid &= ValidationUtils.validatePhone(guardianContactInfoField);

        // Validate date of birth
        if (dateOfBirthPicker.getValue() == null) {
            ValidationUtils.setErrorStyle(dateOfBirthPicker, "Date of birth is required");
            isValid = false;
        } else {
        ...
        if (statusComboBox.getValue() == null) {
            ValidationUtils.setErrorStyle(statusComboBox, "Status is required");
            isValid = false;
        } else {
        ...
        isValid &= ValidationUtils.validateRequired(clusterField);

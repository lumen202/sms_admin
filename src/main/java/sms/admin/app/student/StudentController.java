...
public class StudentController extends FXController {
    ...
    private void handleExport(String type) {
        try {
            ...
            fileChooser.setTitle("Save " + type.toUpperCase() + " File");

            // Set initial filename
            String defaultFileName = "students_" + LocalDate.now().toString() + "." + type.toLowerCase();
            fileChooser.setInitialFileName(defaultFileName);

            // Set extension filter based on type
            FileChooser.ExtensionFilter extFilter = new FileChooser.ExtensionFilter(
                    type.toUpperCase() + " files (*." + type.toLowerCase() + ")",
                    "*." + type.toLowerCase());
